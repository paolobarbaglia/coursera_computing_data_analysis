# Part 1
outcome <- read.csv(file="C:/workspace_computing_for_data_analysis/Assignments/week3/ProgAssignment3-data/outcome-of-care-measures.csv", colClasses = "character")
head(outcome)
names(outcome)
...
# Part 4
hospital <- read.csv(file="C:/workspace_computing_for_data_analysis/Assignments/week3/ProgAssignment3-data/hospital-data.csv", colClasses = "character")
head(hospital)
